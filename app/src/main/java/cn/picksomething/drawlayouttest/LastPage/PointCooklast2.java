...
/**
 * Created by tt791_000 on 2016/9/9.
 */
public class PointCooklast2 extends AppCompatActivity {
    ...
    private void initAdapter() {//傳資料近來
        ...
        {Intent intent = getIntent();
            ...
            if(wtpart.equals("T1"))
                title.setText("牛");
            else if(wtpart.equals("T2"))
                title.setText("豬");
            else if(wtpart.equals("T3"))
                title.setText("雞");
            else if(wtpart.equals("T4"))
                title.setText("羊");
            else if(wtpart.equals("T5"))
                title.setText("鴨");
            else if(wtpart.equals("T6"))
                title.setText("鵝");
            else if(wtpart.equals("T7"))
                title.setText("魚");}
        else
        {   Intent intent2 = getIntent();
            ...
            if(wtpart.equals("T8"))
                title.setText("海鮮");
            else if(wtpart.equals("T9"))
                title.setText("菇");
            else if(wtpart.equals("T10"))
                title.setText("豆");
            else if(wtpart.equals("T11"))
                title.setText("澱粉");
            else if(wtpart.equals("T12"))
                title.setText("葉菜根莖");
            else if(wtpart.equals("T13"))
                title.setText("果實");
            else if(wtpart.equals("T14"))
                title.setText("蛋");}

        Cursor cursor = myDB.SelectPointCook(wtpart);
        ...
        lv.setAdapter(new ListAdapter(this,group,child,wtpart,"PointCookLast"));
    }
    ...
    protected void initTitle()//返回鍵與地圖
    {
        ...
        map.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(PointCooklast2.this,MapButton.class));
            }
        });
        ...
        public View getView(final int position, View convertView, ViewGroup parent)
        {
            ...
            holder.btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    dbhelp.addlist(group.get(position),"ingredient",ig);
                    //存值進去
                }
            });
