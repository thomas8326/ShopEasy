 ...
 */
public class CookBooklast4Point extends FragmentActivity {
    ...
    protected void dataconn() {
        ...
        Cursor data2 = mydb.SelectIGPosition(totlaID.getInt(0));
        Cursor data3 = mydb.SelectIGClassName(totlaID.getInt(0));
...
//                dbhelp.addDataFromCBToFavorite(Foodname,mID,mIG,"PointCookLast",setData1);
//            }
//        });
    }
    ...
    protected void init()
    {
        ...
        map.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(CookBooklast4Point.this,MapButton.class));
            }
        });
