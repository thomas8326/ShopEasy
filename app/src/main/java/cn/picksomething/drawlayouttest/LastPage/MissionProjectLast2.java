 ...
 */
public class MissionProjectLast2 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String mission_project = bundle.getString("itemPart");

        title.setText("過節慶");

        Cursor cursor = dbhelp.SelectMissionProject2(mission_project);
    ...
    protected void init()
    {
        ...
        map.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MissionProjectLast2.this,MapButton.class));
            }
        });
